...
def purchase_shop_ads_package(package_name):
    ...
    api_url = f"{scheme}://{control_plane_url}/api/method/rokct.control.billing.charge_customer_for_addon"
    ...
    try:
        ...
        if response_json.get("status") != "success":
            frappe.throw(response_json.get("message", "Payment failed."), title="Payment Error")
