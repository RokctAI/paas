...
def get_parcel_order_settings():
    ...
    try:
        settings = frappe.get_list(
            ...
            fields=["name", "type", "img", "min_width", "max_width", "min_height", "max_height", "min_length", "max_length", "max_range", "min_g", "max_g", "price", "price_per_km", "special", "special_price", "special_price_per_km"],
            order_by="price asc"
        )
        return settings
