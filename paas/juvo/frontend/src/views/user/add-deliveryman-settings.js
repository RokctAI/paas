...
import deliveryVehicleTypeService from '../../services/rest/deliveryVehicleType';
...
const DeliverySettingCreate = ({ data, handleCancel }) => {
  ...
  const [vehicleTypes, setVehicleTypes] = useState([]); // Dynamic vehicle types
  ...
  const fetchVehicleTypes = async () => {
    try {
      const result = await deliveryVehicleTypeService.getAll();
              ...
              <Col span={12}>
                ...
                >
                  <Select
                    ...
                    placeholder={vehicleTypes.length === 0 ? t('loading') : t('select.vehicle.type')}
                  />
                </Form.Item>
              </Col>
              <Col span={12}>
