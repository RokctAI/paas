...
use App\Http\Controllers\API\v1\Dashboard\Admin\DeliveryVehicleTypeController;
use App\Http\Controllers\API\v1\Rest\DeliveryVehicleTypeController as RestDeliveryVehicleTypeController;

use App\Http\Controllers\Web\TelegramBotController;
use App\Models\Page;
use Illuminate\Support\Facades\Route;
use App\Http\Controllers\API\v1\Dashboard\ERPGoController;

///Resources API
use App\Http\Controllers\API\v1\Rest\Resources\ROSystemController;
use App\Http\Controllers\API\v1\Rest\Resources\TankController;
use App\Http\Controllers\API\v1\Rest\Resources\MaintenanceRecordController;
use App\Http\Controllers\API\v1\Rest\Resources\EnergyConsumptionController;
use App\Http\Controllers\API\v1\Rest\Resources\ExpensesController;
use App\Http\Controllers\API\v1\Dashboard\User\PayfastCredentialController;
use App\Http\Controllers\API\v1\Dashboard\Payment\PayFastCardController;
use App\Http\Controllers\API\v1\Dashboard\Admin\ShopDashboardController;
use App\Http\Controllers\API\v1\Rest\AppUsageController;

///Loans
use App\Http\Controllers\API\v1\Dashboard\User\LoanController;
use App\Http\Controllers\API\v1\Dashboard\User\LoanDocumentController;
use App\Http\Controllers\API\v1\Dashboard\User\MembershipController;
...
//    Route::get('/login/{provider}',                 [LoginController::class,'redirectToProvider']);
    ...
    Route::get('status', [App\Http\Controllers\API\v1\Rest\StatusController::class, 'simpleStatus']);
    Route::get('status/details', [App\Http\Controllers\API\v1\Rest\StatusController::class, 'detailedStatus']);

    Route::get('delivery-vehicle-types', [RestDeliveryVehicleTypeController::class, 'dropdown']);



Route::middleware(['sanctum.check'])->group(function () {
    // App usage tracking
    Route::post('app-usage/record', [AppUsageController::class, 'recordUsage']);
    Route::get('app-usage/stats', [AppUsageController::class, 'getStats']);
});
    ...
    return [
        ...
        /* Weather */
        Route::get('weather', [App\Http\Controllers\API\v1\Rest\Weather\WeatherController::class, 'getWeather'])
    ->middleware('sanctum.check');


        /* Resources */
        // Add our new resource routes
    Route::prefix('resources')->group(function () {

    // Strategic dashboard resources
    
    // Vision routes
    Route::get('visions', [App\Http\Controllers\API\v1\Rest\Resources\VisionController::class, 'index']);
    Route::get('visions/{uuid}', [App\Http\Controllers\API\v1\Rest\Resources\VisionController::class, 'show']);
    Route::post('visions', [App\Http\Controllers\API\v1\Rest\Resources\VisionController::class, 'store']);
    Route::put('visions/{uuid}', [App\Http\Controllers\API\v1\Rest\Resources\VisionController::class, 'update']);
    Route::delete('visions/{uuid}', [App\Http\Controllers\API\v1\Rest\Resources\VisionController::class, 'destroy']);
    
    // Pillar routes
    Route::get('pillars', [App\Http\Controllers\API\v1\Rest\Resources\PillarController::class, 'index']);
    Route::get('pillars/{uuid}', [App\Http\Controllers\API\v1\Rest\Resources\PillarController::class, 'show']);
    Route::post('pillars', [App\Http\Controllers\API\v1\Rest\Resources\PillarController::class, 'store']);
    Route::put('pillars/{uuid}', [App\Http\Controllers\API\v1\Rest\Resources\PillarController::class, 'update']);
    Route::delete('pillars/{uuid}', [App\Http\Controllers\API\v1\Rest\Resources\PillarController::class, 'destroy']);
    
    // Strategic Objective routes
    Route::get('objectives', [App\Http\Controllers\API\v1\Rest\Resources\StrategicObjectiveController::class, 'index']);
    Route::get('objectives/{uuid}', [App\Http\Controllers\API\v1\Rest\Resources\StrategicObjectiveController::class, 'show']);
    Route::post('objectives', [App\Http\Controllers\API\v1\Rest\Resources\StrategicObjectiveController::class, 'store']);
    Route::put('objectives/{uuid}', [App\Http\Controllers\API\v1\Rest\Resources\StrategicObjectiveController::class, 'update']);
    Route::delete('objectives/{uuid}', [App\Http\Controllers\API\v1\Rest\Resources\StrategicObjectiveController::class, 'destroy']);
    
    // KPI routes
    Route::get('kpis', [App\Http\Controllers\API\v1\Rest\Resources\KpiController::class, 'index']);
    Route::get('kpis/{uuid}', [App\Http\Controllers\API\v1\Rest\Resources\KpiController::class, 'show']);
    Route::post('kpis', [App\Http\Controllers\API\v1\Rest\Resources\KpiController::class, 'store']);
    Route::put('kpis/{uuid}', [App\Http\Controllers\API\v1\Rest\Resources\KpiController::class, 'update']);
    Route::delete('kpis/{uuid}', [App\Http\Controllers\API\v1\Rest\Resources\KpiController::class, 'destroy']);
    
    // Todo Task routes
    Route::get('tasks', [App\Http\Controllers\API\v1\Rest\Resources\TodoTaskController::class, 'index']);
    Route::get('tasks/{uuid}', [App\Http\Controllers\API\v1\Rest\Resources\TodoTaskController::class, 'show']);
    Route::post('tasks', [App\Http\Controllers\API\v1\Rest\Resources\TodoTaskController::class, 'store']);
    Route::put('tasks/{uuid}', [App\Http\Controllers\API\v1\Rest\Resources\TodoTaskController::class, 'update']);
    Route::delete('tasks/{uuid}', [App\Http\Controllers\API\v1\Rest\Resources\TodoTaskController::class, 'destroy']);
    
    // Plan on a Page - Complete view
    Route::get('plan-on-page/{shop_id?}', [App\Http\Controllers\API\v1\Rest\Resources\PlanOnPageController::class, 'index']);

// App routes
Route::get('apps', [App\Http\Controllers\API\v1\Rest\Resources\AppController::class, 'index']);
Route::get('apps/{uuid}', [App\Http\Controllers\API\v1\Rest\Resources\AppController::class, 'show']);
Route::post('apps', [App\Http\Controllers\API\v1\Rest\Resources\AppController::class, 'store']);
Route::put('apps/{uuid}', [App\Http\Controllers\API\v1\Rest\Resources\AppController::class, 'update']);
Route::delete('apps/{uuid}', [App\Http\Controllers\API\v1\Rest\Resources\AppController::class, 'destroy']);

// Roadmap Version routes
Route::get('roadmap-versions', [App\Http\Controllers\API\v1\Rest\Resources\RoadmapVersionController::class, 'index']);
Route::get('roadmap-versions/{uuid}', [App\Http\Controllers\API\v1\Rest\Resources\RoadmapVersionController::class, 'show']);
Route::post('roadmap-versions', [App\Http\Controllers\API\v1\Rest\Resources\RoadmapVersionController::class, 'store']);
Route::put('roadmap-versions/{uuid}', [App\Http\Controllers\API\v1\Rest\Resources\RoadmapVersionController::class, 'update']);
Route::delete('roadmap-versions/{uuid}', [App\Http\Controllers\API\v1\Rest\Resources\RoadmapVersionController::class, 'destroy']);

 // Get all personal mastery goals (with optional filters)
    Route::get('personal-mastery-goals', 'App\Http\Controllers\API\v1\Rest\Resources\PersonalMasteryGoalController@index');
    
    // Get a specific personal mastery goal by UUID
    Route::get('personal-mastery-goals/{uuid}', 'App\Http\Controllers\API\v1\Rest\Resources\PersonalMasteryGoalController@show');
    
    // Create a new personal mastery goal
    Route::post('personal-mastery-goals', 'App\Http\Controllers\API\v1\Rest\Resources\PersonalMasteryGoalController@store');
    
    // Update an existing personal mastery goal
    Route::put('personal-mastery-goals/{uuid}', 'App\Http\Controllers\API\v1\Rest\Resources\PersonalMasteryGoalController@update');
    
    // Delete a personal mastery goal
    Route::delete('personal-mastery-goals/{uuid}', 'App\Http\Controllers\API\v1\Rest\Resources\PersonalMasteryGoalController@destroy');
 ...
 // Expenses Routes
    ...
    Route::patch('expenses/{id}', [ExpensesController::class, 'partialUpdate']);  
    Route::delete('expenses/{id}', [ExpensesController::class, 'destroy']);
    Route::get('expenses/statistics', [ExpensesController::class, 'getStatistics']);
    Route::get('expenses-types', [ExpensesController::class, 'getTypes']);

    // Energy Consumption specific endpoint
    Route::get('energy-consumption/{shopId}', 
        [EnergyConsumptionController::class, 'index']
    )->name('energy.consumption');

    // RO Systems
    Route::get('ro-systems/{shopId}', [ROSystemController::class, 'show']);
    Route::post('ro-systems', [ROSystemController::class, 'store']);
    Route::put('ro-systems/{id}', [ROSystemController::class, 'update']);
    Route::patch('ro-systems/{id}', [ROSystemController::class, 'partialUpdate']);
    Route::delete('ro-systems/{id}', [ROSystemController::class, 'destroy']);
    Route::patch('ro-systems/vessels/{vesselId}/stage', [ROSystemController::class, 'updateVesselStage']);
    Route::get('ro-systems/{id}/efficiency', [ROSystemController::class, 'getEfficiency']);
    Route::get('ro-systems/{id}/maintenance-history', [ROSystemController::class, 'getMaintenanceHistory']);
    Route::patch('ro-systems/{systemId}/membrane', [ROSystemController::class, 'updateMembrane']);
    ...
    Route::patch('maintenance-records/{id}', [MaintenanceRecordController::class, 'partialUpdate']);
    Route::delete('maintenance-records/{id}', [MaintenanceRecordController::class, 'destroy']);
    Route::post('maintenance-records/batch', [MaintenanceRecordController::class, 'batchStore']);
        ...
        Route::delete('tanks/{tank}', [TankController::class, 'destroy']);
        Route::patch('tanks/{tank}/status', [TankController::class, 'updateStatus']);
        Route::patch('tanks/{tank}/pump', [TankController::class, 'updatePumpStatus'])->name('tanks.updatePumpStatus');
    ...
    Route::group(['prefix' => 'dashboard'], function () {
        ...
        Route::group(['prefix' => 'user', 'middleware' => ['sanctum.check'], 'as' => 'user.'], function () {
            ...
            Route::get('payfast-credentials',              [PayfastCredentialController::class, 'getUserCredentials']);
...
Route::middleware(['auth:sanctum'])    ->prefix('loan')     ->group(function () {
        ...
        Route::get('history-eligibility', [LoanController::class, 'checkLoanHistoryEligibility']);
        Route::post('financial-eligibility', [LoanController::class, 'checkFinancialEligibility']);
        
        // Loan Application Management
        Route::post('save-incomplete', [LoanController::class, 'saveIncompleteLoanApplication']);
        Route::post('application', [LoanController::class, 'submitLoanApplication']);
	Route::get('saved-application', [LoanController::class, 'getSavedApplication']);
	Route::get('saved-applications', [LoanController::class, 'getSavedApplications']);
        
        // Contract Management
        Route::get('{loanId}/contract', [LoanController::class, 'fetchLoanContract']);
        Route::post('{loanId}/contract/accept', [LoanController::class, 'acceptLoanContract']);
        Route::post('{loanId}/contract/decline', [LoanController::class, 'declineLoanContract']);
        Route::post('{loanId}/generate-pdf', [LoanController::class, 'generateContractPdf']);
    });


/*
|--------------------------------------------------------------------------
| ERPGo Integration Routes (For Flutter App)
|--------------------------------------------------------------------------
|
| These routes handle ERPGo integration from the Foodyman Flutter app
| All routes require seller authentication using the role middleware
|
*/

Route::middleware(['auth:sanctum', 'role:seller|moderator'])->prefix('erpgo')->group(function () {
    Route::post('/connect', [ERPGoController::class, 'connect']);
    Route::get('/status', [ERPGoController::class, 'status']);
    Route::post('/disconnect', [ERPGoController::class, 'disconnect']);

    // Dashboard and data access
    Route::get('/dashboard', [ERPGoController::class, 'getDashboardData']);
    Route::get('/profile', [ERPGoController::class, 'getERPGoProfile']);
    
    // Data synchronization
    Route::post('/sync/orders', [ERPGoController::class, 'syncOrders']);
    Route::post('/sync/customers', [ERPGoController::class, 'syncCustomers']);
    Route::post('/sync/products', [ERPGoController::class, 'syncProducts']);
    
    // ERPGo features accessible from Foodyman
    Route::get('/reports/sales', [ERPGoController::class, 'getSalesReport']);
    Route::get('/reports/financial', [ERPGoController::class, 'getFinancialReport']);
    Route::get('/inventory', [ERPGoController::class, 'getInventoryStatus']);
    Route::get('/employees', [ERPGoController::class, 'getEmployees']);
});

/*
|--------------------------------------------------------------------------
| Staff ERPGo Access Routes
|--------------------------------------------------------------------------
|
| These routes allow restaurant staff (waiters, cooks, etc.)
| to access ERPGo features IF their restaurant is connected to ERPGo
|
*/

Route::middleware(['auth:sanctum', 'role:waiter|cook|staff'])->prefix('staff/erpgo')->group(function () {
    
    // Check if restaurant has ERPGo access
    Route::get('/access-check', [ERPGoController::class, 'checkStaffAccess']);
    
    // Limited ERPGo features for staff
    Route::get('/inventory', [ERPGoController::class, 'getStaffInventoryView']);
    Route::get('/daily-reports', [ERPGoController::class, 'getStaffDailyReports']);
    Route::post('/attendance', [ERPGoController::class, 'markStaffAttendance']);
    
});

/*
|--------------------------------------------------------------------------
| Webhook Routes from ERPGo
|--------------------------------------------------------------------------
|
| These routes handle incoming webhooks from ERPGo when data changes
| (e.g., inventory updates, employee changes, etc.)
|
*/

Route::middleware(['webhook.verify.erpgo'])->prefix('webhooks/erpgo')->group(function () {
    
    Route::post('/inventory-updated', [ERPGoController::class, 'handleInventoryUpdate']);
    Route::post('/employee-updated', [ERPGoController::class, 'handleEmployeeUpdate']);
    Route::post('/financial-report-ready', [ERPGoController::class, 'handleReportReady']);
    
});

Route::middleware(['auth:sanctum'])    ->prefix('loan/{loanId}/documents')    ->group(function () {

	// Document Management
        Route::get('/', [LoanDocumentController::class, 'listDocuments']);
        Route::post('/', [LoanDocumentController::class, 'uploadDocuments']);
        Route::get('/{documentType}/download', [LoanDocumentController::class, 'download']);
        Route::delete('/{documentType}', [LoanDocumentController::class, 'deleteDocument']);
    });
            ...
            // PayFast Card Payment Routes
    // Direct card payment processing
    Route::post('pay-fast-direct',                      [PayFastCardController::class, 'directCardPayment']);
    // Token payment processing
    Route::post('pay-fast-token',                       [PayFastCardController::class, 'tokenPayment']);
    // Tokenize card
    Route::post('tokenize-card',                        [PayFastCardController::class, 'tokenizeCard']);
    // Get saved cards
    Route::get('saved-cards',                           [PayFastCardController::class, 'getSavedCards']);
    // Delete saved card
    Route::delete('saved-cards/{id}',                   [PayFastCardController::class, 'deleteCard']);
    // Capture Token
    Route::get('token-capture', [PayFastCardController::class, 'captureToken']);
    Route::get('test-token', [PayFastCardController::class, 'testTokenInfo']);
    Route::post('tokenize-card-only', [PayFastCardController::class, 'tokenizeCardOnly']);
        ...
        Route::group(['prefix' => 'admin', 'middleware' => ['sanctum.check', 'role:admin|manager'], 'as' => 'admin.'], function () {
            ...
            /* Dashboard */
Route::get('shops/dashboard/summary', 		    [Admin\ShopDashboardController::class, 'summary']);
...
Route::get('delivery-vehicle-types-dropdown', [DeliveryVehicleTypeController::class, 'dropdown']);

    // Optionally add full CRUD routes:
    Route::apiResource('delivery-vehicle-types', DeliveryVehicleTypeController::class);
    Route::post('delivery-vehicle-types/{vehicleType}/toggle-active', [DeliveryVehicleTypeController::class, 'toggleActive']);
    Route::get('retail-vehicle-types', [DeliveryVehicleTypeController::class, 'retailTypes']);
    Route::get('agriculture-vehicle-types', [DeliveryVehicleTypeController::class, 'agricultureTypes']);
