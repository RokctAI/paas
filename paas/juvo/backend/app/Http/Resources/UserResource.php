...
class UserResource extends JsonResource
{
    ...
    public function toArray($request): array
    {
        ...
        // Get membership data if the user has an active membership
        $membership = null;
        if ($this->relationLoaded('userMembership') && $this->userMembership && $this->userMembership->is_active) {
            $membershipData = $this->userMembership->membership;
            ...
            $membership = [
                ...
                'duration_unit' => $membershipData->duration_unit,
                'start_date' => $this->userMembership->start_date->format('Y-m-d H:i:s') . 'Z',
                'end_date' => $this->userMembership->end_date->format('Y-m-d H:i:s') . 'Z',
                'is_active' => $this->userMembership->is_active,
            ];
        }
        ...
        return [
            ...
            'membership'            => $membership, // Add membership data to the response
