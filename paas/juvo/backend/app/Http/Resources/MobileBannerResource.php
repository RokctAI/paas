...
class MobileBannerResource extends JsonResource
{
    ...
    public function toArray($request): array
    {
        ...
        return [
            ...
            'url'           => $this->url,
            'img'           => $this->img,
            'active'        => (bool)$this->active,  // Explicitly cast to boolean
            'clickable'     => (bool)$this->clickable, // Explicitly cast to boolean
            'input'         => $this->input ? (bool)$this->input : null, // Handle null case
            'type'          => $this->type,
            ...
            'shops'         => MobileShopResource::collection($this->whenLoaded('shops')),
        ];
    }
}
